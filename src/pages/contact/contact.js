                ...
                <div className="d-flex flex-wrap align-items-center">
                    <div className="col-12 col-lg-6 info">
                        ...
                        <div className="d-flex align-items-center info-div">
                            ...
                            <a href="https://www.facebook.com/share/1EJAKg2n2t/?mibextid=wwXIfr" className="link contact-info">{t("contact.social")}</a>
                        </div>
                        <div className="d-flex align-items-center info-div">
                            <FontAwesomeIcon icon={faInstagram} className="contact-logo"></FontAwesomeIcon>
                            <a href="https://instagram.com/boniannabil?igshid=YmMyMTA2M2Y=" className="link contact-info">{t("contact.social")}</a>
                        </div>
                        <div className="d-flex align-items-center info-div">
